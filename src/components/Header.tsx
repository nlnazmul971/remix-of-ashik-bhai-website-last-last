          ...
          <div>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center gap-4 sm:gap-6 h-14 sm:h-20 relative">
                ...
                <Link to="/" className="shrink-0 flex items-center justify-center w-[240px] mt-4 sm:mt-0 absolute left-1/2 -translate-x-1/2 sm:static sm:translate-x-0 sm:w-auto" aria-label="Home">
