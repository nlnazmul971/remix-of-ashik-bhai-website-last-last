    ...
    <footer className="bg-background text-foreground border-t border-border mt-12 pb-[120px] sm:pb-0">
      <div className="max-w-6xl mx-auto px-4 sm:px-8 py-7 sm:py-10">
        ...
        <div className="mb-7 sm:mb-9 text-center">
          <h2 className="font-['Cormorant_Garamond',serif] text-3xl sm:text-4xl tracking-tight mb-2 text-foreground">{brandName}</h2>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 mb-7 sm:mb-9 sm:max-w-md sm:mx-auto">
          <div>
            <h4 className="text-[10px] font-semibold tracking-[0.2em] mb-2.5 text-foreground uppercase">Collection</h4>
            <ul className="space-y-1.5">
              <li><Link to="/" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Home</Link></li>
              <li><Link to="/about" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">About Us</Link></li>
              <li><Link to="/shop" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Shop</Link></li>
              <li><Link to="/blog" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Blog</Link></li>
              <li><Link to="/contact" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Contact</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-[10px] font-semibold tracking-[0.2em] mb-2.5 text-foreground uppercase">Policy</h4>
            <ul className="space-y-1.5">
              <li><Link to="/privacy-policy" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Privacy Policy</Link></li>
              <li><Link to="/terms" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Terms</Link></li>
              <li><Link to="/refund-policy" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Refund Policy</Link></li>
              <li><Link to="/shipping-policy" className="text-[10px] tracking-wider text-muted-foreground hover:text-foreground transition-colors">Shipping</Link></li>
            </ul>
          </div>
        </div>
